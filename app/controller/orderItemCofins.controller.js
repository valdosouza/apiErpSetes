...
const Tb = db.orderitemcofins;

class OrderItemCofinsController extends Base {
  ...
  static async sync(body) {
    const promise = new Promise(async (resolve, reject) => {
      try {
        ...
        reject("OrderItemCofinsController.sync:" + error);
      }
    });
    return promise;
  }
  ...
  static async getById(tb_order_item_id, tb_order_id, tb_institution_id, terminal) {
    const promise = new Promise((resolve, reject) => {
      try {
        ...
        reject('OrderItemCofinsController.getById: ' + err);
      }
    });
    return promise;
  };
...
module.exports = OrderItemCofinsController;