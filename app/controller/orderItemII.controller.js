...
const Tb = db.orderitemii;

class OrderItemIiController extends Base {
  ...
  static async sync(body) {
    const promise = new Promise(async (resolve, reject) => {
      try {
        ...
        reject("OrderItemIiController.sync:" + error);
      }
    });
    return promise;
  }
  ...
  static async getById(tb_order_item_id, tb_order_id, tb_institution_id, terminal) {
    const promise = new Promise((resolve, reject) => {
      try {
        ...
        reject('OrderItemIiController.getById: ' + err);
      }
    });
    return promise;
  };
...
module.exports = OrderItemIiController;