...
const Tb = db.orderitemipi;

class OrderItemIpiController extends Base {
  ...
  static async sync(body) {
    const promise = new Promise(async (resolve, reject) => {
      try {
        ...
        reject("OrderItemIpiController.sync:" + error);
      }
    });
    return promise;
  }
  ...
  static async getById(tb_order_item_id, tb_order_id, tb_institution_id, terminal) {
    const promise = new Promise((resolve, reject) => {
      try {
        ...
        reject('OrderItemIpiController.getById: ' + err);
      }
    });
    return promise;
  };
...
module.exports = OrderItemIpiController;