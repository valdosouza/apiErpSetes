...
const Tb = db.orderitempis;

class OrderItemPisController extends Base {
  ...
  static async sync(body) {
    const promise = new Promise(async (resolve, reject) => {
      try {
        ...
        reject("OrderItemPisController.sync:" + error);
      }
    });
    return promise;
  }
  ...
  static async getById(tb_order_item_id, tb_order_id, tb_institution_id, terminal) {
    const promise = new Promise((resolve, reject) => {
      try {
        ...
        reject('OrderItemPisController.getById: ' + err);
      }
    });
    return promise;
  };
...
module.exports = OrderItemPisController;