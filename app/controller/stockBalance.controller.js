  ...
  static getList(body) {
    const promise = new Promise(async (resolve, reject) => {
      try {
        ...
        body.tb_stock_list_id = 1;
        var stock = await entityHasStockListController.getByEntity(body.tb_institution_id, body.tb_salesman_id);
        body.tb_stock_list_id
        body.tb_stock_list_id = stock.tb_stock_list_id;
